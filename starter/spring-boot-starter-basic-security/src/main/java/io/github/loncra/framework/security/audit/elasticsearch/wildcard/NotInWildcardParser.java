 ...
 * @author maurice.chen
 */
public class NotInWildcardParser implements WildcardParser<BoolQuery.Builder> {
    ...
    public void structure(
        ...
        Query termsQuery = Query.of(q -> q.terms(t -> t.field(property.getFinalPropertyName()).terms(terms -> terms.value(values.stream().map(FieldValue::of).toList()))));
        queryBuilder.mustNot(termsQuery);
    }
