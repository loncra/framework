 ...
 * @author maurice.chen
 */
public class EqWildcardParser implements WildcardParser<BoolQuery.Builder> {
    ...
    public void structure(
        ...
        Query termQuery = QueryBuilders
                .term(t -> t.field(property.getFinalPropertyName()).value(property.getValue().toString()));
