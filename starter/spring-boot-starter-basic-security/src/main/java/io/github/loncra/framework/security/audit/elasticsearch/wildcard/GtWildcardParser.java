 ...
 * @author maurice.chen
 */
public class GtWildcardParser implements WildcardParser<BoolQuery.Builder> {

    private final static String DEFAULT_WILDCARD_VALUE = "gt";

    private final static String DEFAULT_WILDCARD_NAME = "大于";
    ...
    public void structure(
        ...
        rangeBuilder.term(t -> t.field(property.getFinalPropertyName()).gt(property.getValue().toString()));
