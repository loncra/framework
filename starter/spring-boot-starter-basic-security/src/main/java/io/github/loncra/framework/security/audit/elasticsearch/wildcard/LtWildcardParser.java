 ...
 * @author maurice.chen
 */
public class LtWildcardParser implements WildcardParser<BoolQuery.Builder> {
    ...
    public void structure(
        ...
        rangeBuilder.term(t -> t.field(property.getFinalPropertyName()).lt(property.getValue().toString()));
