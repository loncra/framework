 ...
 * 2021/10/16 16:36:13
 */
public class TemplateField extends BaseBean {
    ...
    private TemplateFieldMultiCheckBox fieldMultiCheckbox;
    ...
    private TemplateFieldMultiRadio fieldMultiRadio;
    ...
    public TemplateFieldMultiCheckBox getFieldMultiCheckbox() {
        return fieldMultiCheckbox;
    }

    public void setFieldMultiCheckbox(TemplateFieldMultiCheckBox fieldMultiCheckbox) {
    ...
    public TemplateFieldMultiRadio getFieldMultiRadio() {
        return fieldMultiRadio;
    }

    public void setFieldMultiRadio(TemplateFieldMultiRadio fieldMultiRadio) {
