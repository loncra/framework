...
public class Base64 {
    ...
    private static boolean isBase64(byte octect) {
        if (octect == PAD) {
            ...
            if (octect < 0 || BASE_64_ALPHABET[octect] == -1) {
                return false;
            }
            else {
                return true;
    ...
    public static byte[] encode(
        ...
        for (i = 0; i < tripletCount; i++) {
            ...
            encodedData[encodedIndex + 1] = LOOK_UP_BASE_64_ALPHABET[val2 | (k << 4)];
            encodedData[encodedIndex + 2] = LOOK_UP_BASE_64_ALPHABET[(l << 2) | val3];
    ...
    public static byte[] decode(byte[] base64Data) {
        ...
        for (int i = 0; i < numberQuadruple; i++) {
            ...
            b1 = BASE_64_ALPHABET[base64Data[dataIndex]];
            b2 = BASE_64_ALPHABET[base64Data[dataIndex + 1]];

            if (marker0 != PAD && marker1 != PAD) {
                // No PAD e.g 3cQl
                b3 = BASE_64_ALPHABET[marker0];
                b4 = BASE_64_ALPHABET[marker1];
