...
| **持久层** | [`spring-boot-starter-mybatis`](starter/spring-boot-starter-mybatis/README.md)、[`spring-boot-starter-mybatis-plus`](starter/spring-boot-starter-mybatis-plus/README.md)；写操作留痕 **`OperationDataTraceRepository`**、可选 **`OperationDataTraceRecordHook`**；与 spring-security-core 合并 **`operationTrace`** 见各模块 README |
...
| **spring-boot-starter-mybatis** | MyBatis TypeHandler、JSON 集合拦截、写操作留痕 **`OperationDataTraceRepository`** 与 Hook | [starter/…/README.md](starter/spring-boot-starter-mybatis/README.md) |
| **spring-boot-starter-mybatis-plus** | MP 插件链、加密、多租户、默认 **`MybatisPlusOperationDataTraceRepository`** | [starter/…/README.md](starter/spring-boot-starter-mybatis-plus/README.md) |
...
| **spring-boot-starter-spring-security** | Spring Security 多子模块；控制器 **`AuditEventInterceptor`** 与 **`@OperationDataTrace`** 写库留痕 | [starter/…/README.md](starter/spring-boot-starter-spring-security/README.md) |
